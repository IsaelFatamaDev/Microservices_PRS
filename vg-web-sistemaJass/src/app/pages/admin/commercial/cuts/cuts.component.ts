...
@Component({
    ...
    <div>
      <div class="mb-6">
        ...
        <p class="text-gray-500">Gestión de cortes y reconexiones</p>
      </div>
      <div class="bg-white rounded-xl shadow-sm p-12 text-center">
        <lucide-icon [img]="scissorsIcon" [size]="64" class="text-gray-300 mx-auto mb-4"></lucide-icon>
        <p class="text-gray-500">Módulo en desarrollo</p>
      </div>
    </div>
  `
})
export class CutsComponent {
